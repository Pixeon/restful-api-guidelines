...
[#111]
== {SHOULD} Treat Open API Definitions As Open For Extension By Default
...
`application/x.pixeon.study+json;version=2`. For incompatible changes, a new
...
[source,http]
----
Accept: application/x.pixeon.study+json;version=2
----
...
[source,http]
----
Content-Type: application/x.pixeon.study+json;version=2
----
