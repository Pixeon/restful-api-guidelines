...
:keywords: Pixeon, Guidelines, RESTful, API, Events, Schema
...
= Pixeon RESTful API and Event Scheme Guidelines

image::assets/api-pixeon-small.jpg[API Guild Logo]

Other formats: link:pixeon-guidelines.pdf[PDF], link:pixeon-guidelines.epub[EPUB3]
